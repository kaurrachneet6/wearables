...
% subject_ID 
NameF1='PDMotion';
NameF2=['0001'; '0003'; '0006'; '0010'; '0011';...
    '0013'; '0014';'0019'; '0020'; '0022';...
    '0023';'0024'; '0025'; '0026';'0027';...
    '0028';'0029';'0030']; % 10 PD, 8 HOA
...
st_1 = zeros(18,5,4); % original start
st_2 = zeros(18,5,4);
st_3 = zeros(18,5,4); % revised start
st_4 = zeros(18,5,4);


% loop through every subject
for subj = [1:size(NameF2,1)] % fix 6 later (PD), fix 6 later (Control), fix 1 (Control, RT), fix 8 (PD, RT)
    %% importing data
...
st_flag = zeros(18,5,4); % flag trials where start significantly differ
...
save('startstop_retest.mat','st_1','st_2','st_3','st_4','st_flag')
...
for subj = [1:size(NameF2,1)] % fix 6 later (PD), fix 6 later (Control), fix 1 (Control, RT), fix 8 (PD, RT)
    Name1 = strcat('Wlet',NameF2(subj,:));
    
    %% importing data
    for i = 1:3 % loop through UE task
        Name2 = NameA2(i);
        Name3=NameU3(1);
        temp = strcat(home_path,'Analysis',s,'Full_Retest',s,'Wlet',NameF2(subj,:),Name2,Name3,NameF4,Name4);
        A = imread(temp); 
